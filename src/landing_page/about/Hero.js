...
function Hero(){
    return(
      ...
      Now, we are breaking ground with our technology.</h1>
              ...
              <div className="row text-center p-5 mt-5 border-top text-muted " style={{lineHeight:"1.8",fontSize:"1.1em"}}>
                    ...
                    <div className="col-6 p-5">
                        ...
                        <p>And yet, we are always up to something new every day. Catch up on the latest updates on our <a href=""  style={{textDecoration:"none"}}>blog</a> or see what the media is <a href=""  style={{textDecoration:"none"}}>saying about us</a> or learn more about our business and product philosophies.</p>
