...
function Stats(){
    return(
          ...
          <div className="row p-5">
            ...
            <div className="col-6 p-5">
                <img src="media\images\ecosystem.png" style={{width:"120%",height:"100%"}}></img>
                <div className="text-center">
                    <a href="" className="mx-5" style={{textDecoration:"none"}}>Explore our Page <i class="fa-solid fa-arrow-right"></i></a>
