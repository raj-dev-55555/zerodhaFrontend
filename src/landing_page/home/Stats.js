        ...
        <div className="container p-3 p-md-5">
            <div className="row">
                ...
                <div className="col-12 col-md-6 p-3 p-md-5 text-center">
                    <img src="media/images/ecosystem.png" className="img-fluid"></img>
                    <div className="mt-3">
                        <a href="" className="mx-3" style={{textDecoration:"none"}}>Explore our Page <i className="fa-solid fa-arrow-right"></i></a>
